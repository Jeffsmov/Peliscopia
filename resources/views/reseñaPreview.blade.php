...
<div class="col-md-10 row">
    <div class="head">
        <div class="row">
            <div class="col-md-12"> <a href="/movie/{{$peliculaId}}">{{$peliculaName}}</a> <a href="/" class="more-reviews">(Más reviews)</a><a href=""></a> </div>
        </div>
        
        <div class="row">
            <div class="col-md-12"> <a href="/perfil/{{$reviewAutorId}}" class="more-reviews">{{$reviewAutorName}}</a> <a href="/" class="more-reviews">(Más reviews)</a> <span class="more-reviews pull-right">{{$reviewFecha}}</span></div>
        </div>
    </div>
